...
const WalletCard = ({cardPressed, walletsLinked} : {cardPressed : Function, walletsLinked: number}) => {
      ...
      <div id="card">
        <div className="card-content">
          ...
          <p id="prompt">
            ...
            :
              <>
                {walletsLinked} {walletsLinked > 1 ? "WALLETS" : "WALLET"} LINKED 
              </>
            } 
            <Image
                src={Wallet.src}
          ...
          {!walletsLinked &&
            ...
            <div className="subtitle">
              ...
              <>
                ...
                <span className="highlight">to link a wallet to your account</span>
              </>
              :
