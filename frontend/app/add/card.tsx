...
const Card = ({cardPressed, isLinked, logo, name} : {cardPressed : Function, isLinked : boolean, logo: any, name: string}) => {

  const innerComponent = (
    <div className="container noselect" onClick={() => cardPressed()}>
      ...
      <div id="card">
        <div className="card-content">
          ...
          <p id="prompt">
            ...
            :
              <>
                {name.toUpperCase()} LINKED 
              </>
            } 
            {logo}
            </p>
          <div className="title">CLICK<br />TO LINK</div>
          {!isLinked &&
            ...
            <div className="subtitle">
              {!isLinked ?
              <>
                <span>Click on this card</span>
                <span className="highlight">to link your {name} account</span>
              </>
              :
  ...
  return (
    name === "Twitter" ?
      <StyledWrapperTwitter>
        {innerComponent}
      </StyledWrapperTwitter>
    : name === "LinkedIn" ?
      <StyledWrapperLinkedin>
        {innerComponent}
      </StyledWrapperLinkedin>
    :
      <StyledWrapperWallet>
...
const StyledWrapperTwitter = styled.div`
.container {
  position: relative;
  width: 190px;
  height: 254px;
...
.highlight {
  color: #1DA1F2;
  margin-left: 5px;
  background: linear-gradient(90deg, #1DA1F2, #81c6f2);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  font-weight: bold;
}
...
.glow-3 {
  ...
  background: radial-gradient(
    circle at center,
    rgba(129, 198, 242, 0.3) 0%,
    rgba(129, 198, 242, 0.3) 70%
  );
  filter: blur(15px);
  opacity: 0;
...
const StyledWrapperWallet = styled.div`
.container {
  position: relative;
  width: 190px;
  height: 254px;
...
.title {
  ...
  width: 100%;
  padding-top: 20px;
  background: linear-gradient(45deg,rgb(119, 0, 255),rgb(204, 0, 255));
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  filter: drop-shadow(0 0 15px rgba(149, 0, 255, 0.3));
  text-shadow:
    0 0 10px rgba(92, 103, 255, 0.5),
    0 0 20px rgba(92, 103, 255, 0.3);
}
...
.highlight {
  color:rgb(121, 29, 242);
  margin-left: 5px;
  background: linear-gradient(90deg,rgb(160, 29, 242),rgb(208, 129, 242));
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  font-weight: bold;
}
...
#card:hover .corner-elements span {
  border-color: rgba(171, 92, 255, 0.8);
  box-shadow: 0 0 10px rgba(174, 92, 255, 0.5);
}`;

const StyledWrapperLinkedin = styled.div`
.container {
  position: relative;
  width: 190px;
  height: 254px;
...
.title {
  ...
  width: 100%;
  padding-top: 20px;
  background: linear-gradient(45deg, #007dbb, #007dbb);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  filter: drop-shadow(0 0 15px rgba(0, 255, 170, 0.3));
  text-shadow:
...
.highlight {
  color: #1DA1F2;
  margin-left: 5px;
  background: linear-gradient(90deg, #007dbb, #007dbb);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  font-weight: bold;
}
